...
<RenderComparison slug="surface-darkest" classes="amb-surface-darkest" />

## Lighter surfaces

Headroom above `.amb-surface` is physically narrow — a Lambertian plate
caps out near albedo 1.0 — so these sit close together compared to the
darker ladder.

<RenderComparison slug="surface-lighter" classes="amb-surface-lighter" />
<RenderComparison slug="surface-lightest" classes="amb-surface-lightest" />
