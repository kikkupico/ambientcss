  ...
  return (
    <div className="docs-css-examples">
      <section className="docs-demo-shell docs-bright-theme">
        ...
        <div className="ambient amb-surface amb-fillet amb-elevation-2 amb-rounded-lg docs-css-row-panel">
          <button className="ambient amb-surface-convex amb-fillet amb-elevation-1 amb-rounded-md" style={miniButtonStyle}>Play</button>
          <button className="ambient amb-surface-convex amb-fillet amb-elevation-1 amb-rounded-md" style={miniButtonStyle}>Stop</button>
          <button className="ambient amb-surface-convex amb-fillet amb-elevation-1 amb-rounded-md" style={miniButtonStyle}>Rec</button>
        </div>
        </div>
      </section>
      ...
      <section className="docs-demo-shell docs-bright-theme">
        ...
        <div className="docs-css-grid-two">
          <div className="ambient amb-surface amb-fillet amb-elevation-2 amb-rounded-lg amb-light-tl docs-css-block" />
          <div className="ambient amb-surface amb-fillet amb-elevation-2 amb-rounded-lg amb-light-br docs-css-block" />
        </div>
        </div>
      </section>
      ...
      <section className="docs-demo-shell docs-bright-theme">
        ...
        <div className="docs-css-grid-two">
          <article className="ambient amb-surface amb-fillet amb-elevation-2 amb-rounded-lg" style={cardStyle}>
